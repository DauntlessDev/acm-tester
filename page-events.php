<!--ection class="section1-events"></section-->
<section class="section2-events">
    <div class="container">
...
<section class="section3-events cd-timeline js-cd-timeline">
		...
		<div class="container container--lg cd-timeline__container">
			<div class="cd-timeline__block">
                ...
                <div class="flex flex--space-between flex--center-y">
                    <span class="cd-timeline__date">Aug 3-4</span>
            ...
            <div class="cd-timeline__block">
                ...
                <div class="flex flex--space-between flex--center-y">
                    <span class="cd-timeline__date">Sept 2</span>
                    <!--a href="#0" class="btn btn--subtle">Read more</a-->
                </div>
                </div> <!-- cd-timeline__content -->
            </div> <!-- cd-timeline__block -->
            <div class="cd-timeline__block">
                ...
                <div class="flex flex--space-between flex--center-y">
                    <span class="cd-timeline__date">Oct 25</span>
                    <!--a href="#0" class="btn btn--subtle">Read more</a-->
                </div>
				</div> <!-- cd-timeline__content -->
            </div> <!-- cd-timeline__block -->
            ...
            <div class="cd-timeline__block">
                ...
                <div class="flex flex--space-between flex--center-y">
                    <span class="cd-timeline__date">Oct 7</span>
                    <!--a href="#0" class="btn btn--subtle">Read more</a-->
                </div>
                </div> <!-- cd-timeline__content -->
            </div> <!-- cd-timeline__block -->
            ...
            <div class="cd-timeline__block">
                ...
                <div class="flex flex--space-between flex--center-y">
                    <span class="cd-timeline__date">Every Month</span>
                    <!--a href="#0" class="btn btn--subtle">Read more</a-->
                </div>
                </div> <!-- cd-timeline__content -->
            </div> <!-- cd-timeline__block -->

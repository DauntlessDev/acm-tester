...
<html lang="">
  ...
  <body>
    ...
    <div class="main-content">
	  ...
	  <!-- Display success message from php -->
	  <div class="alert alert-danger <?= isset($_SESSION['error-msg']) ? "" : "hidden" ?>">
  		<?= isset($_SESSION['error-msg']) ? $_SESSION['error-msg'] : "" ?>
	  </div>
	  <?php if(isset($_SESSION['error-msg'])) $_SESSION['error-msg'] = null; // clear session after displaying?>

	  <!-- Display error message from php -->
	  <div class="alert alert-success <?= isset($_SESSION['success-msg']) ? "" : "hidden" ?>">
  		<?= isset($_SESSION['success-msg']) ? $_SESSION['success-msg'] : "" ?>
	  </div>
	  <?php if(isset($_SESSION['success-msg'])) $_SESSION['success-msg'] = null; // clear session after displaying?>

      <!--div class='ad'><div class="close"><i class="ion-ios-close-empty"></i></div><script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
        // kodhus demos
        <ins class="adsbygoogle"
             style="display:inline-block;width:300px;height:250px"
             data-ad-client="ca-pub-8408356133845039"
             data-ad-slot="8154430505"></ins><script>
                ...
                <div class="row">
                  ...
                  <form action="backend/add-member.php" method="POST">
                    <div class="form-group">
                      ...
                      <input type="text" name="first-name" class="form-control" value="Paresh" required="">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-info add-new" data-toggle="modal" data-target="#addmember">
            ...
            <div class="table-wrapper2">
              <div class="table-title">
                ...
                <table class="table table-bordered data-table">
                  ...
                  <tbody>
					  <?php include_once "backend/fetch-member.php" ?>

					  <?php foreach($members as $ind=>$member): ?>
					  <form id="member-form<?=$ind?>" action="backend/delete-member.php" method="POST">
					  ...
					  <tr>
						  ...
						  <td>
							  ...
							  <button class="btn btn-danger btn-xs btn-delete" onclick="document.getElementById(<?="'member-form".$ind."'"?>).submit();">Delete</button>
						  </td>
					  </tr>
				  	  <?php endforeach;?>
				  </tbody>
